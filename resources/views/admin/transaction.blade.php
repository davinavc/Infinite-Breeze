...
@section('content')
    ...
    <div class="dashboard-content">
        <div class="staff-list">
            ...
            @endif
            <a href="{{ route('dashboard.admin.transaction') }}" class="add-staff-inactive">
                <span class="dropdown-icon material-symbols-outlined">verified_user</span>
                Verify
            </a>
            <a href="{{ route('dashboard.admin.viewtransaction') }}" class="add-staff" style="gap:5px">
                        ...
                        <tr>
                            ...
                            <td class="button-group">
                                <div class="group-button-action">
                                    @if($status === 'Pending')
                                        <form action="{{ route('admin.transaction.accept', $trx->id) }}" method="POST">
                                            @csrf
                                        ...
                                        <form action="{{ route('admin.transaction.reject', $trx->id) }}" method="POST">
                                            @csrf
