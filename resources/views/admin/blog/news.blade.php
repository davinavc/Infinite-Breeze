...
@section('content')
    <main>
        <center><h2 class="upcoming-h2" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">NEWS</h2></center>
        ...
        <div class="container my-5 space-event" >
            <div class="row row-cols-1 row-cols-md-3 g-4">
                    ...
                    <div class="card shadow">
                        ...
                        @if($header)
                            ...
                            <div class="card-body general">
                                ...
                                <a class="card-text d-flex justify-content-end read-more" href="{{ route('blog.detailnews', $blog->id) }}">Read More <span class="material-symbols-outlined">arrow_forward</span></a>
                            </div>
                ...
                <div class="col-12" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="200">
                    <center><p>NO BLOG WITH CATEGORY 'NEWS  '</p></center>
                </div>
                @endforelse
            </div>
        </div>
