...
@section('content')
    <main>
        <center><h2 class="upcoming-h2" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">ON COMING EVENT</h2></center>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body general">
                            ...
                            <p class="card-text d-flex align-items-center mb-1" ><span class="material-symbols-outlined me-2">calendar_month</span>
                                {{ \Carbon\Carbon::parse($event->start_date)->translatedFormat('d F Y')  . ' s.d ' . \Carbon\Carbon::parse($event->finish_date)->translatedFormat('d F Y') }}
                            ...
                            <a class="card-text d-flex justify-content-end read-more" href="{{ route('blog.detailongoing', $event->id) }}">Read More <span class="material-symbols-outlined">arrow_forward</span></a>
                        </div>
